...
def get_flights(
    ...
    """
    Get flight options from fixture data with budget-aware pricing.
    ...
    Args:
        ...
        tier_prefs: Preferred flight tiers (budget, mid, premium)
    ...
    flights.extend(
        _generate_fixture_flights(origin, dest_airport, outbound_date, avoid_overnight, tier_prefs)
    )
    ...
    if end_date != start_date:
        ...
        flights.extend(
            _generate_fixture_flights(dest_airport, origin, return_date, avoid_overnight, tier_prefs)
        )
...
def _generate_fixture_flights(
    ...
    """Generate fixture flight options for a route and date with budget awareness."""
    flights: list[FlightOption] = []
    ...
    # Filter variations by preferred tiers
